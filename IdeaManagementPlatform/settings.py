"""
Django settings for IdeaManagementPlatform project.
...
SECRET_KEY = 'django-insecure-*$*af!*2s-h02f^i5&2fjs4(e^inp+_du-18@4i(ur%)iv+wet'
...
WSGI_APPLICATION = 'IdeaManagementPlatform.wsgi.application'
